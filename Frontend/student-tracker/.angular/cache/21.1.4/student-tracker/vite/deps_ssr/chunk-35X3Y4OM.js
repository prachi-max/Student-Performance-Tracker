...
function coerceObservable(data) {
  if (!(0, import_rxjs8.isObservable)(data)) {
    return (0, import_rxjs8.of)(data);
  }
  return data;
}
...
var TreeKeyManager = class {
  ...
  _items = [];
  _typeahead;
  _typeaheadSubscription = import_rxjs9.Subscription.EMPTY;
  ...
  constructor(items, config) {
    ...
    } else if ((0, import_rxjs9.isObservable)(items)) {
  ...
  change = new import_rxjs9.Subject();
  destroy() {
  ...
  _expandAllItemsAtCurrentItemLevel() {
    ...
    let itemsToExpand;
    if (!parent) {
      itemsToExpand = (0, import_rxjs9.of)(this._items.filter((item) => item.getParent() === null));
    } else {
...
//# sourceMappingURL=chunk-35X3Y4OM.js.map
